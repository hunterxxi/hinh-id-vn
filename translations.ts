// File: translations.ts - PHIÊN BẢN HOÀN CHỈNH ĐẦY ĐỦ NGÔN NGỮ
...
const enTranslations = {
    ...
    printModalContent: "This is an experimental feature, currently available only to customers living or working in Vietnam.",
    ...
    errorImageProcess: "Could not process the image. The file may be corrupt.",
...
const viTranslations = {
    ...
    printModalContent: "Đây là một tính năng thử nghiệm, hiện chỉ dành cho khách hàng sinh sống hoặc làm việc tại Việt Nam.",
    ...
    errorImageProcess: "Không thể xử lý ảnh. Tệp có thể bị hỏng.",
...
export const translations: Record<string, Record<string, any>> = {
    en: enTranslations,
    vi: viTranslations,
    id: { ...enTranslations, languageSwitcherTitle: "Bahasa" },
    pt: { ...enTranslations, languageSwitcherTitle: "Língua" },
    ms: { ...enTranslations, languageSwitcherTitle: "Bahasa" },
    cs: { ...enTranslations, languageSwitcherTitle: "Jazyk" },
    es: { ...enTranslations, languageSwitcherTitle: "Idioma" },
    fr: { ...enTranslations, languageSwitcherTitle: "Langue" },
    de: { ...enTranslations, languageSwitcherTitle: "Sprache" },
    el: { ...enTranslations, languageSwitcherTitle: "Γλώσσα" },
    hu: { ...enTranslations, languageSwitcherTitle: "Nyelv" },
    it: { ...enTranslations, languageSwitcherTitle: "Lingua" },
    nl: { ...enTranslations, languageSwitcherTitle: "Taal" },
    th: { ...enTranslations, languageSwitcherTitle: "ภาษา" },
    tr: { ...enTranslations, languageSwitcherTitle: "Dil" },
    uk: { ...enTranslations, languageSwitcherTitle: "Мова" },
    ru: { ...enTranslations, languageSwitcherTitle: "Язык" },
    ko: { ...enTranslations, languageSwitcherTitle: "언어" },
    ja: { ...enTranslations, languageSwitcherTitle: "言語" },
    ar: { ...enTranslations, languageSwitcherTitle: "اللغة" },
    'zh-CN': { ...enTranslations, languageSwitcherTitle: "语言" },
    'zh-TW': { ...enTranslations, languageSwitcherTitle: "語言" }
};
// File: my-gemini-worker/src/index.ts - PHIÊN BẢN SỬA LỖI 405
...
export default {
    async fetch(request: Request, env: Env, ctx: ExecutionContext): Promise<Response> {
        ...
        // --- BƯỚC XỬ LÝ YÊU CẦU KIỂM TRA 'OPTIONS' (SỬA LỖI 405) ---
        // Nếu đây là yêu cầu "kiểm tra an ninh", hãy trả lời ngay lập tức với các header cho phép
        if (request.method === 'OPTIONS') {
            return new Response(null, { headers: corsHeaders(origin) });
        }
        // --- KẾT THÚC SỬA LỖI ---

        // Chỉ cho phép yêu cầu POST, các yêu cầu khác sẽ bị từ chối
        ...
        try {
            ...
            return new Response(`Failed to generate image: ${error.message}`, { status: 500, headers: corsHeaders(origin) });
        }
    },
};
